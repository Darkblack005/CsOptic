...
var coinflipschema = new mongoose.Schema({
    csteamid: { type: String },
    jsteamid: { type: String },
...
var coinflipmodel = mongoose.model('coinflip', coinflipschema)
...
FlipManager.prototype.sendWinner = function sendWinner(ctWin, coinflipIndex) {
    ...
    self.Trade.getInventory('76561198159926602', '730', '2', (err, data) => {
        ...
        async.forEach(flipItems, (index, cb) => {
            ...
            var flipToSave = new coinflipmodel({
                csteamid: self.currentflips[coinflipIndex].flipDetails.steamID64,
                jsteamid: self.currentflips[coinflipIndex].joinData.data.steamID64,
                commission: commission,
                date: { type: Date, default: Date.toLocaleString('en-US'), required: true }
            })
