...
FlipManager.prototype.sendWinner = function sendWinner(ctWin, coinflipIndex) {
    this.Trade.getInventory('76561198159926602', '730', '2', (err, data) => {
        ...
        async.forEach(flipItems, (index, cb) => {
            ...
            var creatorWon = booloverride || (coinflips[coinflipIndex].flipDetails.side && ctWin)
            const winnerTradeLink = creatorWon ? coinflips[coinflipIndex].flipDetails.tradelink : coinflips[coinflipIndex].joinData.data.tradelink
