...
FlipManager.prototype.sendWinner = function sendWinner(ctWin, coinflipIndex) {
    Trade.getInventory(76561198159926602, '730', '2', (err, data) => {
        ...
        async.forEach(flipItems, (index, cb) => {
            ...
            const winnerTradeLink = booloverride || (coinflips[coinflipIndex].flipDetails.side && ctWin) ? coinflips[coinflipIndex].flipDetails.tradelink : coinflips[coinflipIndex].joinData.data.tradelink
