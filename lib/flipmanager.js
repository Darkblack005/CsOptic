...
FlipManager.prototype.tradeAccepted = function tradeAccepted(steamID64) {
    ...
    if(!isAJoiner) {
        ...
        this.currentflips[this.currentJoined[j].flipId].joinData = this.currentJoined[j]

        this.currentFlipsDataForPublic[this.currentJoined[j].flipId].joinData = this.currentJoined[j]
