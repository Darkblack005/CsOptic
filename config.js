...
module.exports = {
    ...
    website: 'https://localhost',    // Website URL, follow the example (do not add / at the end)
    ...
    flipDeleteTimout: 15,    // After the flip finishes, how long to wait before deleting it (in seconds)
